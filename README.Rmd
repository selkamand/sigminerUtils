...
Run on a cohort of samples using a manifest file (see `?sig_analyse_cohort_from_files()` for details on the expected manifest format)
...
sig_analyse_mutations_single_sample_from_files(
  ...
  ref_umaps = "pcawg_reference_set/refmatrix.umaps.rds.bz2",
  include = "pass",
  ref = "hg38",
